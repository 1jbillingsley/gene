...
class TestAgentsSDKIntegrationFlow:
    ...
    def test_full_message_processing_flow(self, mock_settings):
        ...
        assert mock_client._conversation_context["last_prompt"] == "analyze this complex scenario"
    ...
    def test_backward_compatibility(self):
        ...
        enhanced_fields = ["agent_id", "conversation_id", "structured_output", "tokens_used"]
